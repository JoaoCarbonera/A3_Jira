...
* CT-03: Retornar erro se exceção ocorrer no registro (dados inválidos).
* CT-04: Retornar 401 em caso de senha incorreta.
* CT-05: Retornar 409 se usuário inexistente no login.
* CT-06: Criar Tarefa com sucesso.
* CT-07: Editar Descrição de Tarefa com sucesso.
* CT-08: Editar Status da tarefa com sucesso.
* CT-09: Login com e-mail não cadastrado.
* CT-10: Login com sucesso.
